          ...
          <div id="results-section" className="bg-white/95 text-slate-900 rounded-[24px] p-6 md:p-8 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] animate-in fade-in slide-in-from-bottom-4 duration-500 w-full shrink-0">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mb-4">
                <div>
                   ...
                   <div className="text-[16px] font-semibold text-slate-800 mb-3">R$ {travelCost.toFixed(2).replace('.', ',')}</div>
                   
                   <div className="text-[13px] text-slate-500">Saída Fixa</div>
                   <div className="text-[16px] font-semibold text-slate-800">R$ {BASE_FEE.toFixed(2).replace('.', ',')}</div>
                </div>
                <div>
                   ...
                   <div className="text-[16px] font-semibold text-slate-800">R$ {stairsCost.toFixed(2).replace('.', ',')}</div>
                </div>
             </div>
